...
Recurring plot-critical objects use approved canonical WebPs as permanent production authority.

## Priority Chapter 1 Objects

- brass Cafe Siete token marked `7`
- brass-rimmed Cafe Siete connection clock `CLOCK-CAFE-01`
...
Planned authorities:
- `cafe-siete-clock-canonical-reference-prompt.md` → `cafe-siete-clock-canonical-reference.webp`
- `san-aurelio-station-clock-canonical-reference-prompt.md` → `san-aurelio-station-clock-canonical-reference.webp`
...
`CLOCK-STATION-01` and `CLOCK-CAFE-01` are separate physical objects.

Station clock:
- large matte dark-iron institutional clock
- ivory enamel face
- hour/minute hands only
- no brass rim
- fixed `12:07` in 2026
- never resets during Cafe meetings

Cafe clock:
- smaller brass-rimmed Cafe Siete wall clock
- includes thin second hand
- resets to `12:00` at connection activation
- controls the active interval

Never merge their design, location, behavior or hand state.
