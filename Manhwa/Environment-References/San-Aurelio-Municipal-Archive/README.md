...
The approved pack must lock:
- one primary rectangular conservation worktable and Daniel's normal seated work position
- fixed evidence/document zones on that table
- fixed conservation-tool tray location
...
Creator/source context remains:
- forty-two water-stained San Aurelio boxes in the recovered collection inventory
- three old tin trunks
