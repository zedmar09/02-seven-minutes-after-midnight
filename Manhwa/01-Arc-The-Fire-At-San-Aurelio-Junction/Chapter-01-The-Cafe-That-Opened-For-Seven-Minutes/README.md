...
- Cafe Siete brass-rimmed clock

Additional object canonicals become mandatory if the audit determines notebook/paper/tongs need stronger repeatable visual authority.
...
- pre-activation station/cafe clue: 12:07 fixed/stopped
- activation: 12:00
- progression: 12:01 → 12:02 → 12:03 → 12:04 → 12:05 → 12:06 → 12:07
- post-closure station clock: 12:07 fixed
...
2. Daniel's clean 2026 archival sheet crosses to 1986 and appears unnaturally new
3. Daniel's warning notebook page crosses to Tomas before closure
4. after closure that SAME warning page returns to 2026 forty years older with Tomas's added line
...
7. stitch
8. run fresh final clean-room audit
