...
adoption_relocations = WORK / 'maintenance/manuscript-adoption-v001/relocations.json'
if adoption_relocations.is_file():
    entries += read(adoption_relocations)['entries']
for row in entries:
