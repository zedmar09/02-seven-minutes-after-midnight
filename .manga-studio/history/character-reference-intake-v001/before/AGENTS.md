...
- Authoritative manuscript versions stay in .manga-studio/manuscript/versions. Chapter 1 v001 is the user-approved active manuscript under approval-feb5212823b84aeaaa04bac3fedc4fc6. No canon or storyboard is adopted; all locks remain false.
...
- Do not activate other versions, approve other artifacts, change locks, draft new chapters, release prompts, publish or push without explicit authorization for that action.
