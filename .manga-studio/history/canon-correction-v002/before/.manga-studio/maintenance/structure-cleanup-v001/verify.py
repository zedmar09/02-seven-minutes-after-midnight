...
canon_proposal = WORK / 'canon/versions/chapter-001-canon-v001.json'
if canon_proposal.is_file():
    errors += validate_json_file(canon_proposal, installed / 'schemas/canon.schema.json')
...
assert authority['proposed_canon_version'] == '.manga-studio/canon/versions/chapter-001-canon-v001.json'
assert authority['proposed_canon_status'] == 'proposed_review_ready'
assert read(safe(authority['proposed_canon_version']))['status'] == 'proposed'
assert config['active_canon_version'] is None and config['stage_locks']['CANON_APPROVED'] is False
