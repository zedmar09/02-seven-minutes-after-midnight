"""Register the corrective v002 environment-reference release packet."""
...
JOB = ".manga-studio/handoff/pending/san-aurelio-junction-2026-v002.json"
HANDOFF = ".manga-studio/handoff/pending/san-aurelio-junction-2026-v002.md"
...
assert job["job_id"] == "san-aurelio-junction-2026-v002"
...
assert job["output_filename"] == ".manga-studio/handoff/generated/san-aurelio-junction-2026-v002.png"
assert all(value is True for key, value in job["scene_state"]["release_attestation"].items() if key not in {"instruction", "blocking_reasons", "post_generation_review"})
assert job["scene_state"]["release_attestation"]["blocking_reasons"] == []
...
assert "Generate the image now. Do not return a gate refusal" in (ROOT / HANDOFF).read_text(encoding="utf-8")
...
new_paths = [
    ...
    JOB,
    HANDOFF,
    ".manga-studio/maintenance/san-aurelio-junction-2026-release-v002/finalize.py",
]
