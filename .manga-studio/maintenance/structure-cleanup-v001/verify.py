...
assert config['workflow_phase'] == 'phase_7_san_aurelio_junction_2026_correction_v003_changes_requested'
...
assert authority['reference_generation_release_status'] == 'san_aurelio_junction_2026_v003_changes_requested_no_v004_released'
...
assert sha(candidate_path) == sha(correction_input_path) == authority['san_aurelio_junction_2026_candidate_sha256'] == '3b6d5136371c338b945ff382cd6182c7ca7e40617a517be5a84a50b19442270f'
assert authority['san_aurelio_junction_2026_candidate_status'] == 'v003_changes_requested_not_approved'
...
assert sum(row['severity'] == 'error' for row in candidate_review['findings']) >= 6
...
assert authority['san_aurelio_junction_2026_correction_job_status'] == 'v003_changes_requested_no_v004_released'
