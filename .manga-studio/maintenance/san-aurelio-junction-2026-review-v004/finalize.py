"""Register the clock-only review of the author-submitted San Aurelio Junction v005 retry."""
...
CANDIDATE = ".manga-studio/continuity/reference-candidates/san-aurelio-junction-2026-v005/candidate.png"
CORRECTION_INPUT = ".manga-studio/handoff/approved/correction-inputs/san-aurelio-junction-2026-v005/candidate.png"
CANDIDATE_SHA = "fb6dd01e53366781c537fa65275ad1e7831cc47dff69da5bb7311d5da0cb27be"
INTAKE = ".manga-studio/continuity/reference-candidates/san-aurelio-junction-2026-v005/intake.json"
REVIEW_JSON = ".manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v005-review.json"
REVIEW_MD = ".manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v005-review.md"
...
FINALIZER = ".manga-studio/maintenance/san-aurelio-junction-2026-review-v004/finalize.py"
...
assert project["workflow_phase"] == "phase_7_san_aurelio_junction_2026_candidate_v005_clock_changes_requested"
...
assert "No v005 image job" in intake["actual_generation_job_provenance"]
assert review["target"] == CANDIDATE and review["status"] == "changes_requested"
error_findings = [row for row in review["findings"] if row["severity"] == "error"]
assert len(error_findings) == 1
assert error_findings[0]["code"] == "SAN-AURELIO-2026-V005-CLOCK-001"
assert any(row["code"] == "SAN-AURELIO-2026-V005-FINISH-001" for row in review["findings"])
...
register["summary"]["generated_reference_candidates"] = 4
register["summary"]["reference_candidates_changes_requested"] = 4
register["summary"]["reference_candidates_finish_pass_clock_only"] = 1

authority = register["current_authority"]
authority["reference_generation_release_status"] = "san_aurelio_junction_2026_v005_clock_changes_requested_no_v006_released"
authority["latest_generated_reference_review_relative_path"] = REVIEW_JSON
authority["san_aurelio_junction_2026_v004_candidate_relative_path"] = ".manga-studio/continuity/reference-candidates/san-aurelio-junction-2026-v004/candidate.png"
authority["san_aurelio_junction_2026_v004_candidate_sha256"] = "6f6cd8238e2d5209963289201957d2506eeaf0727da201175ce763ea7a4f1477"
authority["san_aurelio_junction_2026_v004_candidate_status"] = "changes_requested_not_approved"
...
authority["san_aurelio_junction_2026_candidate_status"] = "v005_clock_changes_requested_not_approved"
...
authority["san_aurelio_junction_2026_author_submitted_retry_status"] = "v005_clock_changes_requested_no_v006_released"
