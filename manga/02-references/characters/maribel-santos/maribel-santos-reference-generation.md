...
[Maribel's specification](maribel-santos.md) and the approved manuscript control her role and written appearance. No image attachment is required for the first candidate. Do not attach the Daniel-and-Tomas image, an environment image, or another story's character. Every generated facial detail is a proposal requiring separate review.
...
Create a finished clean black-and-white human-drawn 2D manga production sketch/reference sheet on white paper. Use confident variable ink contours, small flat solid-black shapes, restrained discrete screentone, and sparse functional hatching. Keep all materials matte and all six studies equally readable.

More resolved than a rough thumbnail, less atmospheric than a story panel. No rough construction residue, color, tint, sepia, gloss, reflections, glow, bloom, rim light, cinematic exposure, vignette, lens effects, blur, smooth gradient, airbrush, painterly grayscale, photorealism, CGI, or 3D shading.
