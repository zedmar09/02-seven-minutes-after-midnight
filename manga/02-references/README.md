...
|---:|---|---|---|---|
| 6 | [San Aurelio Junction, 2026 v005 review](../../.manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v005-review.md) | `san-aurelio-junction-2026-v005.png` | Author-submitted manual retry | Clock change requested |
...
The five character records are fulfilled. San Aurelio Junction 2026 candidates v002 through v004 failed review. The author-submitted [v005 candidate requires one final clock correction](../../.manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v005-review.md): its core manga finish, true grayscale, matte puddles, layout, exclusions, and cross-view continuity pass, but the large ticket-hall clock still reads about 12:05 instead of 12:07. Do not use any candidate as a production reference until it receives explicit approval.

Canon, story, and the 36-page Chapter 1 storyboard are approved, active, hash-bound, and locked. Image generation is enabled and `IMAGE_READY` is true. No v006 correction, later reference, retry, panel, or page handoff is released. Every retry remains versioned and separately authorized.
