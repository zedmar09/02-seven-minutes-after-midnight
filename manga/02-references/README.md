...
|---:|---|---|---|---|
| 6 | [San Aurelio Junction, 2026 v007 review](../../.manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v007-review.md) | `san-aurelio-junction-2026-v007.png` | Author-submitted manual retry | Approval recommended |
...
The five character records are fulfilled. San Aurelio Junction 2026 candidates v002 through v006 failed review. The author-submitted [v007 candidate passes visual review](../../.manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v007-review.md): it has true grayscale pixels, a clear 12:07 clock, acceptable flat manga finish, matte puddles, layout, exclusions, and cross-view continuity. It remains a review candidate until explicit user approval.

Canon, story, and the 36-page Chapter 1 storyboard are approved, active, hash-bound, and locked. Image generation is enabled and `IMAGE_READY` is true. V007 is recommended for approval but not yet promoted. No v008 correction, later reference, retry, panel, or page handoff is released.
