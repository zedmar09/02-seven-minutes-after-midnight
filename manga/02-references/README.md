...
|---:|---|---|---|---|
| 6 | [San Aurelio Junction, 2026 v006 review](../../.manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v006-review.md) | `san-aurelio-junction-2026-v006.png` | Author-submitted manual retry | Clock and grayscale changes requested |
...
The five character records are fulfilled. San Aurelio Junction 2026 candidates v002 through v005 failed review. The author-submitted [v006 candidate requires clock and grayscale corrections](../../.manga-studio/continuity/reviews/chapter-001-san-aurelio-junction-2026-reference-v006-review.md): its manga finish, matte puddles, layout, exclusions, and cross-view continuity pass, but the large clock still reads about 12:05 and the file regressed to subtly tinted RGB. Do not use any candidate as a production reference until it receives explicit approval.

Canon, story, and the 36-page Chapter 1 storyboard are approved, active, hash-bound, and locked. Image generation is enabled and `IMAGE_READY` is true. No v007 correction, later reference, retry, panel, or page handoff is released. Every retry remains versioned and separately authorized.
