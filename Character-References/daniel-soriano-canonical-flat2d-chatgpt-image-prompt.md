# Daniel Soriano — Canonical Flat 2D Character Card Prompt

Create one reusable canonical character reference sheet for Daniel Soriano from `Seven Minutes After Midnight`.
...
- early silver threading concentrated naturally at both temples without making him elderly
- small healed cut/scar across the bridge of the nose; keep exact placement stable across views
- medium-tall, slim understated build
...
Primary work look:
- thin rectangular amber-tinted conservation glasses
- slate-blue matte chore jacket
- neutral matte shirt
- dark trousers
